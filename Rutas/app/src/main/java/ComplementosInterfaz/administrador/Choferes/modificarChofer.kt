...
class modificarChofer : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.modificar_chofer)
        ...
        val btnGuardarChoferModificado: Button = findViewById(R.id.btnGuardarChoferModificado)
        btnGuardarChoferModificado.setOnClickListener {
            showAlertDialog()
        }
    }
