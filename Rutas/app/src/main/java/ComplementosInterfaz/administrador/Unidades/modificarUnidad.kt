...
class modificarUnidad : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnGuardarUnidadModificado: Button = findViewById(R.id.btnGuardarUnidadModificado)
        btnGuardarUnidadModificado.setOnClickListener {
            showAlertDialog()
        }
    }
