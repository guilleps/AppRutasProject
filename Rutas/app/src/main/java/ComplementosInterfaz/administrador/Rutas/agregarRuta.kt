...
class agregarRuta : AppCompatActivity(), GoogleMap.OnMapClickListener,
    OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.agregar_ruta)
        createMapFragment()
        ...
        val btnGuardarRuta: Button = findViewById(R.id.btnGuardarRuta)
